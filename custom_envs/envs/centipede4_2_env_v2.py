...
class Centipede4_2Env_v2(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        MujocoEnv.__init__(
            self, "/Users/gaukharnurbek/Downloads/ppo/custom_envs/envs/centipede_4_2.xml", 5, observation_space=observation_space, **kwargs
        )
    ...
    def step(self, action):
        ...
        terminated = not (self._check_height())
        #terminated = False
        info = {
    ...
    def _check_height(self):
        height = self.get_body_com("torso_1")[1]
