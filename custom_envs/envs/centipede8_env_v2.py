...
class Centipede8Env_v2(MujocoEnv, utils.EzPickle):
    """
        @brief:
    ...
    def __init__(self, CentipedeLegNum=8, **kwargs):
        ...
        xml_path = "/Users/gaukharnurbek/Downloads/ppo/custom_envs/envs/CentipedeEight.xml"
        ...
        self._graph_dict = {
            ...
            "righthip_3":["ankle_3"],
            "ankle_3":[],
            "body_1":["lefthip_2","righthip_3","body_2","bodyupdown_2"],
            "bodyupdown_1":["lefthip_2","righthip_3","body_2","bodyupdown_2"],
            "lefthip_4":["ankle_4"],
            "ankle_4":[],
            "righthip_5":["ankle_5"],
            "ankle_5":[],
            "body_2":["lefthip_4","righthip_5","body_3","bodyupdown_3"],
            "bodyupdown_2":["lefthip_4","righthip_5","body_3","bodyupdown_3"],
            "lefthip_6":["ankle_6"],
            "ankle_6":[],
            "righthip_7":["ankle_7"],
            "ankle_7":[],
            "body_3":["lefthip_6","righthip_7"],
            "bodyupdown_3":["lefthip_6","righthip_7"],
            }

        observation_space = Box(
                low=-np.inf, high=np.inf, shape=(23,2), dtype=np.float64
            )
