...
class Dog10_2Env_v2(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._graph_dict = {
            "rootx":["left_bthigh","left_bthigh_1","left_bthigh_2","left_bthigh_3","left_fthigh","right_bthigh","right_bthigh_1","right_bthigh_2","right_bthigh_3","right_fthigh"],
            "rooty":["left_bthigh","left_bthigh_1","left_bthigh_2","left_bthigh_3","left_fthigh","right_bthigh","right_bthigh_1","right_bthigh_2","right_bthigh_3","right_fthigh"],
            "rootz":["left_bthigh","left_bthigh_1","left_bthigh_2","left_bthigh_3","left_fthigh","right_bthigh","right_bthigh_1","right_bthigh_2","right_bthigh_3","right_fthigh"],
        ...
        if exclude_current_positions_from_observation:
            observation_space = Box(
                low=-np.inf, high=np.inf, shape=(65,2,), dtype=np.float64
            )
        else:
            observation_space = Box(
                low=-np.inf, high=np.inf, shape=(66,2,), dtype=np.float64
            )

        MujocoEnv.__init__(
            self, "/home/ai/Desktop/2023/fall23/thesis/ppo/custom_envs/envs/dog10_2.xml", 5, observation_space=observation_space, **kwargs
        )
