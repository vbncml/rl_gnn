...
class Centipede4_2Env(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, action):
        #print(self.get_body_com("torso_1")[0])
        # x_position_before = self.data.qpos[0]
        x_position_before = self.get_body_com("torso_1")[0]
        self.do_simulation(action, self.frame_skip)
        #x_position_after = self.data.qpos[0]
        x_position_after = self.get_body_com("torso_1")[0]
    ...
    #     y_pos_pre = self.get_body_com("torso_0")[0]
    #     y_pos_post = self.get_body_com("torso_1")[0]
