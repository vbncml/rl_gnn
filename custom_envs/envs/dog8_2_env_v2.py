...
class Dog8_2Env_v2(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._graph_dict = {
            "rootx":["left_bthigh","left_bthigh_1","left_bthigh_2","left_fthigh","right_bthigh","right_bthigh_1","right_bthigh_2","right_fthigh"],
            "rooty":["left_bthigh","left_bthigh_1","left_bthigh_2","left_fthigh","right_bthigh","right_bthigh_1","right_bthigh_2","right_fthigh"],
            "rootz":["left_bthigh","left_bthigh_1","left_bthigh_2","left_fthigh","right_bthigh","right_bthigh_1","right_bthigh_2","right_fthigh"],
        ...
        if exclude_current_positions_from_observation:
            observation_space = Box(
                low=-np.inf, high=np.inf, shape=(53,2,), dtype=np.float64
            )
        else:
            observation_space = Box(
                low=-np.inf, high=np.inf, shape=(54,2,), dtype=np.float64
            )

        MujocoEnv.__init__(
            self, "/Users/gaukharnurbek/Downloads/ppo/custom_envs/envs/dog8_2.xml", 5, observation_space=observation_space, **kwargs
        )
