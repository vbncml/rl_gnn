...
class Dog18_2Env_v2(MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._graph_dict = {
            "rootx":["left_bthigh","left_bthigh_1","left_bthigh_2","left_bthigh_3","left_bthigh_4","left_bthigh_5","left_bthigh_6","left_bthigh_7","left_fthigh",
                     "right_bthigh","right_bthigh_1","right_bthigh_2","right_bthigh_3","right_bthigh_4","right_bthigh_5","right_bthigh_6","right_bthigh_7","right_fthigh"],
            "rooty":["left_bthigh","left_bthigh_1","left_bthigh_2","left_bthigh_3","left_bthigh_4","left_bthigh_5","left_bthigh_6","left_bthigh_7","left_fthigh",
                     "right_bthigh","right_bthigh_1","right_bthigh_2","right_bthigh_3","right_bthigh_4","right_bthigh_5","right_bthigh_6","right_bthigh_7","right_fthigh"],
            "rootz":["left_bthigh","left_bthigh_1","left_bthigh_2","left_bthigh_3","left_bthigh_4","left_bthigh_5","left_bthigh_6","left_bthigh_7","left_fthigh",
                     "right_bthigh","right_bthigh_1","right_bthigh_2","right_bthigh_3","right_bthigh_4","right_bthigh_5","right_bthigh_6","right_bthigh_7","right_fthigh"],
            "left_bthigh":["left_bshin"],
            "left_bshin":["left_bfoot"],
            "left_bfoot":[],
            "left_bthigh_1":["left_bshin_1"],
            "left_bshin_1":["left_bfoot_1"],
            "left_bfoot_1":[],
            "left_bthigh_2": ["left_bshin_2"],
            "left_bshin_2": ["left_bfoot_2"],
            "left_bfoot_2": [],
            "left_bthigh_3": ["left_bshin_3"],
            "left_bshin_3": ["left_bfoot_3"],
            "left_bfoot_3": [],
            "left_bthigh_4": ["left_bshin_4"],
            "left_bshin_4": ["left_bfoot_4"],
            "left_bfoot_4": [],
            "left_bthigh_5": ["left_bshin_5"],
            "left_bshin_5": ["left_bfoot_5"],
            "left_bfoot_5": [],
            "left_bthigh_6": ["left_bshin_6"],
            "left_bshin_6": ["left_bfoot_6"],
            "left_bfoot_6": [],
            "left_bthigh_7": ["left_bshin_7"],
            "left_bshin_7": ["left_bfoot_7"],
            "left_bfoot_7": [],
            "left_fthigh":["left_fshin"],
            "left_fshin":["left_ffoot"],
            "left_ffoot":[],
            "right_bthigh":["right_bshin"],
            "right_bshin":["right_bfoot"],
            "right_bfoot":[],
            "right_bthigh_1":["right_bshin_1"],
            "right_bshin_1":["right_bfoot_1"],
            "right_bfoot_1":[],
            "right_bthigh_2": ["right_bshin_2"],
            "right_bshin_2": ["right_bfoot_2"],
            "right_bfoot_2": [],
            "right_bthigh_3": ["right_bshin_3"],
            "right_bshin_3": ["right_bfoot_3"],
            "right_bfoot_3": [],
            "right_bthigh_4": ["right_bshin_4"],
            "right_bshin_4": ["right_bfoot_4"],
            "right_bfoot_4": [],
            "right_bthigh_5": ["right_bshin_5"],
            "right_bshin_5": ["right_bfoot_5"],
            "right_bfoot_5": [],
            "right_bthigh_6": ["right_bshin_6"],
            "right_bshin_6": ["right_bfoot_6"],
            "right_bfoot_6": [],
            "right_bthigh_7": ["right_bshin_7"],
            "right_bshin_7": ["right_bfoot_7"],
            "right_bfoot_7": [],
            "right_fthigh":["right_fshin"],
            "right_fshin":["right_ffoot"],
            "right_ffoot":[],
        }

        if exclude_current_positions_from_observation:
            observation_space = Box(
                low=-np.inf, high=np.inf, shape=(113,2,), dtype=np.float64
            )
        else:
            observation_space = Box(
                low=-np.inf, high=np.inf, shape=(114,2,), dtype=np.float64
            )

        MujocoEnv.__init__(
            self, "/Users/gaukharnurbek/Downloads/ppo/custom_envs/envs/dog18_2.xml", 5, observation_space=observation_space, **kwargs
        )
    ...
    def _get_obs(self):
        ...
        for node in self._graph_dict:  
            node_feats = []
            if node not in ["rootx","rooty","rootz"]:
                # Obs 1: joint's pos
                node_feats.append(self.data.joint(node).qpos[0])
                # Obs 2: joint's vel
                node_feats.append(self.data.joint(node).qvel[0])
                #node_feats.append(root_feats)   
            else:
                #continue
                # Obs 1: joint's pos
                node_feats.append(np.mean(self.data.joint(node).qpos)) 
                # Obs 2: joint's vel
                node_feats.append(np.mean(self.data.joint(node).qvel))
