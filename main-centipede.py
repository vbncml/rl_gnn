...
import numpy as np
import custom_envs
from network import FeedForwardNN, MLP, GCN, GAT, rGIN, RecurrentGCN, AttentionSTGCN, RecurrentGCN_new, RecurrentTGCN, GCN_test
...
def main(args):
    ...
    if args.mode == 'train':
        env = gym.make('Centipede4_2-v2', render_mode='human')
        #transfer_env = gym.make('Centipede8-v2', render_mode='human')
